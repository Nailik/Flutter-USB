...
class Connector(private val activity: Context) {
    ...
    private val usbPermissionAction = "com.kilianeller.flutter_usb"
    ...
    fun connect(device: UsbDevice) {
        ...
        val mPermissionIntent =
                PendingIntent.getBroadcast(activity, 0, Intent(usbPermissionAction), 0)
        activity.registerReceiver(usbReceiver, IntentFilter(usbPermissionAction))
